CREATE DATABASE "India Election Results";
...
-- What is the total number of seats available for Lok Sabha elections
...
-- Total Seats Won by NDA Allianz (NDA Allianz has following parties)
...
WHERE s.State = 'Maharashtra' AND cr.Constituency_Name = 'PUNE';
